 ...
 */
public class PendingFragment extends Fragment implements TransactionContract.View {
    ...
    public PendingFragment(String token) {
        this.token = token;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        presenter = new PendingPresenter(this, token);
