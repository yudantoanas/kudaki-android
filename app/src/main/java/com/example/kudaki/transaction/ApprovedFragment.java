 ...
 */
public class ApprovedFragment extends Fragment implements TransactionContract.View {
    ...
    ApprovedPresenter presenter;

    ProgressDialog progressDialog;

    public ApprovedFragment(String token) {
        this.token = token;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        presenter = new ApprovedPresenter(this, token);
