...
public class DonePresenter implements TransactionContract.Presenter {
    TransactionContract.View view;
    String token;

    public DonePresenter(TransactionContract.View view, String token) {
        this.view = view;
        this.token = token;
    ...
    public void loadTransaction() {
        ...
        Call<OrderHistoryResponse> call = service.getOrderHistory(token, 15, 0, "DONE");
